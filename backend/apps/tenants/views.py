    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                ...
                value={"name": "Acme Corp", "schema_name": "acme", "plan": "pro"},
                request_only=True,
            ),
            OpenApiExample(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                ...
                "domain": openapi.Schema(
                    type=openapi.TYPE_STRING, example="acme.local"
                ),
            ...
            201: openapi.Response(
                ...
                openapi.Schema(
                    ...
                    properties={
                        ...
                        "name": openapi.Schema(
                            type=openapi.TYPE_STRING, example="Acme Corp"
                        ),
                        "schema_name": openapi.Schema(
                            type=openapi.TYPE_STRING, example="acme"
                        ),
                        "plan": openapi.Schema(type=openapi.TYPE_STRING, example="pro"),
        ...
        request_body=openapi.Schema(
            ...
            properties={
                "action": openapi.Schema(
                    type=openapi.TYPE_STRING, enum=["suspend", "reactivate"]
                )
            },
            required=["action"],
        ),
...
class TenantPlanUpdateView(APIView):
            ...
            200: openapi.Response(
                ...
                openapi.Schema(
                    ...
                    properties={
                        ...
                        "plan": openapi.Schema(
                            type=openapi.TYPE_STRING, example="enterprise"
                        ),
                        "plan_ref": openapi.Schema(
                            type=openapi.TYPE_STRING, example="enterprise"
                        ),
                    },
                ),
    ...
    def post(self, request, tenant_id):
        ...
        try:
            ...
            return Response(
                {"detail": "Plano não encontrado"}, status=status.HTTP_400_BAD_REQUEST
            )
        ...
        examples=[
            OpenApiExample(
                ...
                value={
                    ...
                    "plan": "pro",
                    "plan_ref": "pro",
                    "daily_limits": {"emails_per_day": 10000, "sms_per_day": 2000},
                    "throttle_rates": {"burst": "50/min", "sustained": "1000/day"},
                },
                response_only=True,
            )
        ],
    ...
    def get(self, request, tenant_id):
        ...
        if daily_limits is None:
            daily_limits = getattr(settings, "TENANT_PLAN_DAILY_LIMITS", {}).get(
                plan_code, {}
            )

        throttle_rates = getattr(settings, "TENANT_PLAN_THROTTLE_RATES", {}).get(
            plan_code, {}
        )
