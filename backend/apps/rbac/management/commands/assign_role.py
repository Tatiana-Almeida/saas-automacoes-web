...
class Command(BaseCommand):
    help = 'Assign a role to a user within a tenant schema'
    ...
    def handle(self, *args, **options):
        ...
        return self.stdout.write(self.style.SUCCESS(f'Role "{role_name}" atribuída ao usuário "{username}" no tenant "{tenant_schema}"'))
