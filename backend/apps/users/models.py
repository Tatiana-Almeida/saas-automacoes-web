...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, nome_completo=None, password=None, **extra_fields):
        ...
        return self._create_user(email, nome_completo or 'Admin', password, **extra_fields)
