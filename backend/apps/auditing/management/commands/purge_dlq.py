...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--days', type=int, help='Purge DLQ entries older than this number of days (default from settings)')
    ...
    def handle(self, *args, **options):
        ...
        count = qs.count()
        qs.delete()
        self.stdout.write(self.style.SUCCESS(f"Purged {count} DLQ log(s) older than {days} days"))
