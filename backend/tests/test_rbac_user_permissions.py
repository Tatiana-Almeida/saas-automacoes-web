...
@pytest.mark.django_db
def test_permission_assign_denied_without_manage_users(client, gen_password, create_tenant):
    t = create_tenant(schema_name='echo', domain='echo.localhost', name='Echo', plan='pro')
