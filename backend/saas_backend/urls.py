...
urlpatterns = [
    ...
    path('api/swagger(.json|.yaml)', get_yasg_schema_view(
        openapi.Info(
    ...
    ).without_ui(cache_timeout=0), name='yasg-schema-json'),
    path('api/swagger/', get_yasg_schema_view(
        openapi.Info(
            title="SaaS Automacoes API",
            default_version='v1',
            description="Documentação Swagger gerada por drf-yasg",
        ...
        public=True,
        permission_classes=(AllowAny,),
    ).with_ui('swagger', cache_timeout=0), name='yasg-swagger-ui'),
    path('api/redoc/', get_yasg_schema_view(
        openapi.Info(
            title="SaaS Automacoes API",
            default_version='v1',
        ...
        public=True,
        permission_classes=(AllowAny,),
    ).with_ui('redoc', cache_timeout=0), name='yasg-redoc'),
