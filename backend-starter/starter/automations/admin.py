...
class AutomationAdmin(admin.ModelAdmin):
    list_display = ("name", "user", "type", "is_active", "last_run_at", "last_status", "created_at")
...
class AutomationLogAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("automation", "status", "error_message", "output_payload", "started_at", "finished_at", "created_at")
