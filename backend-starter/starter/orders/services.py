...
from ..models import Order, PaymentTransaction, PaymentStatus, PaymentProvider, OrderStatus
...
class PaymentService:
    ...
    @staticmethod
    @transaction.atomic
    def _process_local(payment: PaymentTransaction, order: Order) -> Tuple[PaymentTransaction, bool]:
    ...
    @staticmethod
    @transaction.atomic
    def _process_stripe(payment: PaymentTransaction, order: Order) -> Tuple[PaymentTransaction, bool]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def _process_paypal(payment: PaymentTransaction, order: Order) -> Tuple[PaymentTransaction, bool]:
        """
    ...
    def handle_webhook(provider: str, payload: dict) -> bool:
        ...
        try:
            if provider == PaymentProvider.STRIPE:
                ...
                logger.warning(f'Webhook received from unsupported provider: {provider}')
                return False
        except Exception as e:
    ...
    def _handle_stripe_webhook(payload: dict) -> bool:
        ...
        #     payment.save()
        #     payment.order.save()
        logger.info(f'Stripe webhook received (placeholder)')
        return True
    ...
    def _handle_paypal_webhook(payload: dict) -> bool:
        ...
        # TODO: Verify signature and process events
        logger.info(f'PayPal webhook received (placeholder)')
        return True
