...
from .views import ProductViewSet, ProductPublicViewSet, CategoryViewSet, TagViewSet
...
urlpatterns = [
    ...
    path('api/public/products', ProductPublicViewSet.as_view({'get': 'list'}), name='public-products'),
]
