...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--html', default=None, help='Optional HTML body (if omitted, a template will be used)')
    ...
    def handle(self, *args, **options):
        ...
        try:
            if html is None:
                context = {"body": body, "site_name": getattr(settings, 'SITE_NAME', 'SaaS')}
